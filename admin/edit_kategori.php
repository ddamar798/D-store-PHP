...
$id = (int) $_GET['id'];
$data = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM kategori WHERE id = $id"));
?>
...
<body class="bg-gray-100 p-6">
    ...
    <form action="../controllers/edit_kategori.php" method="POST" class="bg-white p-4 rounded shadow w-full max-w-md">
